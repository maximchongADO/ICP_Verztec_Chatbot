...
def process_single_file(file_path, embedding_model, faiss_index_path=None):
    """
...
faiss_index = process_single_file(file_to_process, embedding_model, faiss_index_path=existing_faiss_index)
